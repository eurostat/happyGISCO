...
Unit test of module :mod:`happygisco.base`
...
from happygisco.settings import happyError
from happygisco.base import _Decorator
...
# _DecoratorTestCase
#/****************************************************************************/
class _DecoratorTestCase(unittest.TestCase):
    """Class of tests for class :class:`_Decorator`
    """    
    module = 'base'
    ...
    def test_3_place_or_coordinate(self):
        ...
        class dummy(object):
            @_Decorator.parse_place_or_coordinates
